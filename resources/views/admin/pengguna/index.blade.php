...
<div class="content-wrapper">
    <div class="col-sm-12 card">
        <h3 class="ml-3" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin-top:10px; margin-bottom:10px;">DATA PENGGUNA</h3>
    </div>
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ route('auth.view.pengguna') }}" id="searchForm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body border-bottom">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ms-auto">
                                    <form method="GET" action="{{ route('auth.view.pengguna') }}" class="d-inline">
                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $lastActiveStatus = $user->lastActive();
                                        @endphp
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                <div style="display: inline-block; font-size: 15px; padding: 2px 8px; margin-top: 5px; margin-bottom: 5px; width: auto;">
                                                    {{ ucfirst($user->status) }}
                                                </div>
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-block">
                                                    <a href="{{ route('auth.view.edit', ['id' => $user->id]) }}" class="btn btn-warning btn-sm" style="margin-top: 5px; margin-bottom: 5px;">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                </div>
                                                <div class="d-inline-block">
                                                    <form action="{{ route('auth.delete.data', ['id' => $user->id]) }}" method="POST" onsubmit="confirmDelete(event, this);">
                                                        @csrf
                                                        @method('DELETE')
